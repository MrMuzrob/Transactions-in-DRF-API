from api.reports import ReportParams
...
class WriteTransactionSerialiezer(serializers.ModelSerializer):
    user = serializers.HiddenField(default=serializers.CurrentUserDefault())
...
class ReadTransactionSerialiezer(serializers.ModelSerializer):
